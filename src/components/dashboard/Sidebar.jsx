    ...
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col shadow-sm">
      ...
      <nav className="flex-1 py-6 px-4 overflow-y-auto">
        <div className="space-y-1">
          ...
          <div className="pt-4 pb-2"><p className="px-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Content</p></div>
          ...
          <div className="pt-4 pb-2"><p className="px-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Management</p></div>
          ...
          {/* <div className="pt-4 pb-2"><p className="px-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">System</p></div>
